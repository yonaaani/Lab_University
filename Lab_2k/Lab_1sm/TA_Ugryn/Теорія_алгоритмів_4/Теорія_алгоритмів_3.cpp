...
int main()
{
	...
	ShowArr(arr, kol);
	int method;
	cout << "\n\nЯким зовнішнім методом відсортувати масив? " << endl
		<< "1) Природне злиття; " << endl
		<< "2) Багатофазове злиття; " << "\n\n>";
	cin >> method;
	cout << endl;
...
void PolyphaseMergeSort(vector<int>& arr, int kol)
{
	...
	cout << "F1 " << endl;
	PrintSeries(F1);
	//вивід заповненого F2
	cout << endl << "F2 " << endl;
	PrintSeries(F2);
	cout << endl;
	//цикл, в якому здійснюється обмін між файлами
